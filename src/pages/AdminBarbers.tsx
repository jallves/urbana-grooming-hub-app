...
const UserRolesList: React.FC = () => {
  return (
    <div className="p-4 sm:p-6">
      <h4 className="text-lg font-semibold mb-3 text-gray-900 dark:text-white">Lista de Permissões</h4>
      <p className="text-gray-600 dark:text-gray-400">Gerencie os cargos e permissões dos usuários</p>
    </div>
  );
};
