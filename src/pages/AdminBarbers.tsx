...
const UserRolesList: React.FC = () => {
  return (
    <div className="p-4">
      ...
      <p className="text-black-600">Gerencie os cargos e permissões dos usuários</p>
    </div>
  );
};
        ...
        <div className="space-y-8">
          ...
          >
            <TabsList className="grid w-full grid-cols-2 bg-black-100 border border-gray-200">
              ...
              <TabsTrigger 
                value="roles" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-indigo-500 text-black"
              >
