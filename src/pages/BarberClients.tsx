            ...
            <CardContent>
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-11 bg-gray-900 border-gray-700 text-gray-100 placeholder-gray-500 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 rounded-lg"
                />
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-gray-800/50 border-gray-700/50 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-300 uppercase tracking-wide">Total de Clientes</p>
                    <p className="text-2xl font-bold text-white mt-1">{clients.length}</p>
                    <p className="text-xs text-gray-400 mt-1">Base ativa</p>
                  </div>
            ...
            <Card className="bg-gray-800/50 border-gray-700/50 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-300 uppercase tracking-wide">Agendamentos Totais</p>
                    <p className="text-2xl font-bold text-white mt-1">
                      {clients.reduce((sum, client) => sum + client.total_appointments, 0)}
                    </p>
                    <p className="text-xs text-gray-400 mt-1">Atendimentos realizados</p>
                  </div>
            ...
            <Card className="bg-gray-800/50 border-gray-700/50 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-300 uppercase tracking-wide">Clientes Ativos</p>
                    <p className="text-2xl font-bold text-white mt-1">
            ...
            <CardContent className="p-6">
              {filteredClients.length === 0 ? (
                <div className="text-center py-12">
                  <div className="p-6 bg-gray-700 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  {filteredClients.map((client) => {
                    ...
                    return (
                      <Card key={client.id} className="bg-gray-900 border-gray-700 hover:bg-gray-800 transition-all duration-300 hover:shadow-md group">
                        <CardContent className="p-5">
                          <div className="space-y-4">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <div>
                                    <h4 className="font-semibold text-white group-hover:text-amber-500 transition-colors">{client.nome}</h4>
                            ...
                            <div className="bg-gray-800 rounded-lg p-3 space-y-2">
                              <div className="flex items-center justify-between">
                                <span className="text-gray-300 text-sm">Agendamentos</span>
                                <span className="text-amber-400 font-semibold">{client.total_appointments}</span>
                              </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <Button
                                size="sm"
                                variant="outline"
                                className="border-blue-500/50 text-blue-400 bg-blue-900/20 hover:bg-blue-900/40 hover:border-blue-400 transition-all duration-200"
                              ...
                              <Button
                                size="sm"
                                variant="outline"
                                className="border-green-500/50 text-green-400 bg-green-900/20 hover:bg-green-900/40 hover:border-green-400 transition-all duration-200"
