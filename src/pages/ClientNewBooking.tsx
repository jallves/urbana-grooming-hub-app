...
export default function ClientNewBooking() {
  ...
  useEffect(() => {
    document.title = 'Novo Agendamento | Barbearia';
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-800 via-stone-900 to-stone-800">
      {/* Header */}
      <header className="bg-stone-900/80 backdrop-blur-sm border-b border-stone-700">
        <div className={containerClass}>
          <div className="flex items-center py-6">
            <Button
              variant="ghost"
              onClick={() => navigate('/cliente/dashboard')}
              className="mr-4 text-stone-100 hover:bg-stone-700/50 hover:text-white transition"
      ...
      <main className="py-8">
        <div className={containerClass}>
          <Card className="bg-stone-800/50 border border-stone-700 rounded-lg shadow-md">
