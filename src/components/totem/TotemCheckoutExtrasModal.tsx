...
const TotemCheckoutExtrasModal: React.FC<TotemCheckoutExtrasModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-screen h-screen max-w-none m-0 p-0 rounded-none bg-urbana-black/95 border-0 text-urbana-light [&>button[class*='absolute']]:hidden [&>button]:hidden [&_.absolute.right-4.top-4]:hidden">
