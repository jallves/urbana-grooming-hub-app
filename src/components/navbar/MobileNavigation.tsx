...
const MobileNavigation: React.FC<MobileNavigationProps> = ({ 
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <div className={`fixed inset-y-0 right-0 z-50 w-[280px] bg-urbana-black/95 backdrop-blur-md transform transition-transform duration-300 ease-in-out md:hidden border-l border-urbana-gold/30 ${
        isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
      }`}>
        <div className="flex items-center justify-between p-4 border-b border-urbana-gold/30 bg-urbana-black/90">
        ...
        <div className="flex flex-col p-4 h-full bg-urbana-black/90">
          ...
          <div className="border-t border-urbana-gold/30 pt-4 mt-auto bg-urbana-black/80 rounded-t-lg -mx-4 px-4">
            {user ? (
