...
className="group"
\> <Card className="relative bg-urbana-black/90 backdrop-blur-lg border border-urbana-gold/30 rounded-xl shadow-xl hover:shadow-[0_0_30px_rgba(255,215,0,0.3)] transition-all duration-500 h-full flex flex-col p-6 hover:scale-105 hover:border-urbana-gold/60"> <div className="mb-6 flex items-center justify-between"> <div className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-urbana-gold to-yellow-400 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300"> <Scissors size={28} className="text-urbana-black" /> </div> <span className="text-urbana-gold font-playfair font-bold text-xl">{price}</span> </div>
...
return ( <section
 ...
 >
{/\* Modern background elements \*/} <div className="absolute inset-0 opacity-10 pointer-events-none"> <div className="absolute top-20 left-20 w-80 h-80 bg-urbana-gold rounded-full blur-3xl mix-blend-screen animate-pulse" />
\<div
