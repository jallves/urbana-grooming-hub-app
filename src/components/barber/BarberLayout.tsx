...
const BarberLayout: React.FC = () => {
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen w-full relative font-poppins flex">
        {/* 
        ...
        */}
        ...
        {/* Desktop Sidebar - Shadcn Component */}
        ...
        <div className="flex-1 flex flex-col min-h-screen w-full">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="hidden md:block">
                    <SidebarTrigger className="text-urbana-light hover:text-urbana-gold" />
                  </div>
          ...
          {/* Main Content */}
          <main className="relative z-10 w-full pt-[72px] sm:pt-[80px] pb-[120px] md:pb-12 px-4 md:px-6 lg:px-8 transition-all duration-300 flex-1">
