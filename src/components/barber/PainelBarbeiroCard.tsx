...
export type PainelBarbeiroCardVariant = 'default' | 'highlight' | 'success' | 'warning' | 'info';

interface PainelBarbeiroCardProps {
  children: React.ReactNode;
  onClick?: () => void;
  variant?: PainelBarbeiroCardVariant;
  icon?: LucideIcon;
  className?: string;
  disabled?: boolean;
}
...
/**
 * PainelBarbeiroCard - Card com glassmorphism para o Painel do Barbeiro
 * Réplica exata do PainelClienteCard para manter consistência visual
 * 
 * @example
 * ```tsx
 * <PainelBarbeiroCard
 *   variant="highlight"
 *   icon={Calendar}
 *   onClick={() => navigate('/barbeiro/agendamentos')}
 * >
 *   <PainelBarbeiroCardTitle>Agendamentos</PainelBarbeiroCardTitle>
 *   <PainelBarbeiroCardDescription>Ver seus atendimentos</PainelBarbeiroCardDescription>
 * </PainelBarbeiroCard>
 * ```
 */
export const PainelBarbeiroCard: React.FC<PainelBarbeiroCardProps> = ({
  children,
  onClick,
  variant = 'default',
  icon: Icon,
...
/**
 * PainelBarbeiroCardTitle - Título do card
 */
export const PainelBarbeiroCardTitle: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className }) => {
  return (
...
/**
 * PainelBarbeiroCardDescription - Descrição do card
 */
export const PainelBarbeiroCardDescription: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className }) => {
  return (
...
/**
 * PainelBarbeiroCardHeader - Header do card
 */
export const PainelBarbeiroCardHeader: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className }) => {
  return (
...
/**
 * PainelBarbeiroCardContent - Conteúdo do card
 */
export const PainelBarbeiroCardContent: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className }) => {
  return (
...
/**
 * PainelBarbeiroCardFooter - Footer do card
 */
export const PainelBarbeiroCardFooter: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className }) => {
  return (
