...
return ( <section id="gallery" className="relative min-h-screen py-24 bg-gradient-to-b from-white via-urbana-gray/5 to-white overflow-hidden">
{/\* Modern background elements \*/} <div className="absolute inset-0 opacity-3"> <div className="absolute top-32 right-10 w-64 h-64 bg-urbana-gold rounded-full blur-3xl"></div> <div className="absolute bottom-32 left-10 w-80 h-80 bg-urbana-gold rounded-full blur-3xl"></div> </div>
