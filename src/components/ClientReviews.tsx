...
export const ClientReviews: React.FC = () => {
  ...
  return (
    <section className="relative py-20 md:py-32 bg-gradient-to-b from-background via-urbana-black to-background overflow-hidden">
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-40 left-20 w-96 h-96 bg-gradient-radial from-primary via-primary/50 to-transparent rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-40 right-20 w-80 h-80 bg-gradient-radial from-primary/50 via-primary to-transparent rounded-full blur-3xl animate-pulse-slow" />
      </div>

      <div className="absolute inset-0 opacity-[0.02]" style={{
        backgroundImage: 'linear-gradient(30deg, transparent 45%, hsl(var(--primary) / 0.3) 45%, hsl(var(--primary) / 0.3) 55%, transparent 55%), linear-gradient(150deg, transparent 45%, hsl(var(--primary) / 0.3) 45%, hsl(var(--primary) / 0.3) 55%, transparent 55%)',
      ...
      <div className="w-full relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-playfair font-bold mb-6 leading-tight tracking-tight relative inline-block">
            ...
            <span className="block md:inline text-foreground drop-shadow-[0_0_30px_hsl(var(--primary)/0.4)]">
              Clientes Dizem
            </span>
            <motion.div
              initial={{ scaleX: 0 }}
              ...
              viewport={{ once: true }}
              className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-primary to-transparent rounded-full shadow-[0_0_15px_hsl(var(--primary)/0.6)]"
            />
          </h2>
          <p className="text-muted-foreground font-raleway text-xl md:text-2xl leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
        ...
        {stats.totalReviews === 0 ? (
          ...
          >
            <div className="relative bg-background/40 backdrop-blur-xl border-2 border-border/50 rounded-3xl p-12 hover:border-primary/50 transition-all duration-500 overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              
              <div className="relative z-10 text-center">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-primary/10 rounded-full mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-6 lg:px-8">
                ...
                <div className="relative z-10">
                      ...
                      return (
                        <div key={rating} className="flex items-center gap-3">
                          <div className="flex items-center gap-1 w-20">
                            <span className="text-foreground font-medium font-raleway">{rating}</span>
                          ...
                          <div className="flex-1 bg-muted/20 rounded-full h-2.5 overflow-hidden">
                            <motion.div
                              ...
                              viewport={{ once: true }}
                              className="h-full bg-gradient-to-r from-primary to-primary/60 rounded-full shadow-[0_0_8px_hsl(var(--primary)/0.5)]"
                            />
                          </div>
                          <span className="text-muted-foreground font-raleway text-sm w-12 text-right">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-6 border-t-2 border-border/30">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground text-sm font-raleway">Satisfação</p>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <p className="text-muted-foreground text-sm font-raleway">Com comentário</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-2xl font-playfair font-bold text-foreground mb-6 flex items-center gap-3">
              ...
              {stats.recentReviews.length > 0 ? (
                stats.recentReviews.map((review, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative bg-background/40 backdrop-blur-xl border-2 border-border/50 rounded-xl p-6 hover:border-primary/50 transition-all duration-300 group overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
