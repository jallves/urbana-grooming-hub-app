          ...
          {actions.map((action, index) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center p-4 rounded-lg border-2 ${action.borderColor} ${action.bgColor} hover:shadow-md transition-all hover:scale-105 active:scale-95`}
              >
                <div className={`w-12 h-12 rounded-full ${action.bgColor} flex items-center justify-center mb-2 border ${action.borderColor}`}>
