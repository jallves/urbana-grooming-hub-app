...
interface AdminBarberScheduleManagerProps {
  barberId: string;
  barberName?: string;
}

const AdminBarberScheduleManager: React.FC<AdminBarberScheduleManagerProps> = ({ 
  barberId, 
  barberName 
}) => {
...
export default AdminBarberScheduleManager;
