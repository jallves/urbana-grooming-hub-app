  ...
  return (
    <div className="h-full min-h-0 flex flex-col bg-white">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 p-3 sm:p-4 border-b border-gray-200">
        <div>
          <h1 className="text-lg sm:text-xl font-bold text-gray-900">Fluxo de Caixa</h1>
          <p className="text-xs sm:text-sm text-gray-600">Gerencie entradas e saídas financeiras</p>
        </div>
