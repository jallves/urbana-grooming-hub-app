...
import PainelClienteCompletarCadastro from './pages/PainelClienteCompletarCadastro';
            ...
            <Route path="/*" element={
              <AuthProvider>
                ...
                <PermissionsProvider>
                  ...
                  <Route path="/painel-cliente/completar-cadastro" element={
                    <AdminRedirectGuard>
                      <PainelClienteCompletarCadastro />
                    </AdminRedirectGuard>
                  } />
