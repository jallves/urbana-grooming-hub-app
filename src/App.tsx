...
import TotemPaymentCash from './pages/Totem/TotemPaymentCash';
...
import TotemProductPaymentCash from './pages/Totem/TotemProductPaymentCash';
...
import TotemSplitPayment from './pages/Totem/TotemSplitPayment';
            ...
            <Route path="/*" element={
              <AuthProvider>
                <PermissionsProvider>
                  ...
                  <Route path="/totem/payment-cash" element={
                    <AdminRedirectGuard>
                      <TotemProtectedRoute><TotemPaymentCash /></TotemProtectedRoute>
                    </AdminRedirectGuard>
                  } />
                  <Route path="/totem/payment-split" element={
                    <AdminRedirectGuard>
                      <TotemProtectedRoute><TotemSplitPayment /></TotemProtectedRoute>
                    </AdminRedirectGuard>
                  } />
